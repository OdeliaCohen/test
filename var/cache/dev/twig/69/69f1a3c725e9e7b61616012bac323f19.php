...
class __TwigTemplate_314ccdc0c3a227cb12d692ee787ff40b extends Template
{
    private $source;
    private $macros = [];
...
<main>
        ...
        ";
        // line 58
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 58, $this->source); })()), "profileType", [], "any", false, false, false, 58), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
        ";
        // line 59
